...
func renderPublicPage(view PublicPageView, status int) string {
	...
	:root{color:#182126;background:#f3f6f7;font-family:Inter,"Segoe UI","PingFang SC","Microsoft YaHei",Arial,sans-serif}
	*{box-sizing:border-box}body{min-height:100vh;margin:0;display:grid;place-items:center;padding:24px;background:#f3f6f7}
	main{width:min(100%,520px);padding:34px;text-align:center;background:#fff;border:1px solid #d9e3e6;border-radius:8px;box-shadow:0 14px 34px rgba(18,35,44,.08)}
	.mark{width:48px;height:48px;margin:0 auto 18px;display:grid;place-items:center;border-radius:8px;background:#147c6c;color:#fff;font-weight:800}
	h1{margin:0 0 12px;font-size:26px;line-height:1.25;letter-spacing:0}p{margin:0;color:#60747b;line-height:1.7}.status{margin-top:20px;color:#94a3aa;font-size:13px}footer{margin-top:18px;color:#94a3aa;font-size:13px}
